export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxab4ca62bd09b752c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0e28293a9a2572a9da8ac430b0e4df1a",
   ...
   */
  USERS: ["oVdzH6EurfxemYgh0hOc6rDUqaFs"]
    {
      // 想要发送的人的名字
      name: "婷婷",
      ...
      openUrl: "https://616pic.com/sucai/1kxike9mz.html",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oVdzH6EurfxemYgh0hOc6rDUqaFs",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
